 ...
 */
public class LinkageSplitEvaluator
  ...
  private static final int RESULT_SIZE = 17;

  /**
   * No args constructor.
   */
  public LinkageSplitEvaluator() {
  ...
  public Enumeration listOptions() {
	...
	(m_deduper instanceof OptionHandler)) {
      ...
      Enumeration en = ((OptionHandler)m_deduper).listOptions();
  ...
  public String [] getOptions() {
    ...
    if (getDeduper() != null) {
      options[current++] = "-W";
      options[current++] = Utils.removeSubstring(getDeduper().getClass().getName(),
  ...
  public Object [] getResult(Instances trainData, Instances testData) 
    ...
    LinkageEvaluation eval = new LinkageEvaluation();
  ...
  public String toString() {
    ...
    String result = "LinkageSplitEvaluator: ";
    if (m_deduper == null) {
