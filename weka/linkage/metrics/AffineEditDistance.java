...
public class AffineEditDistance extends StringMetric implements OptionHandler, Serializable {

  /** The cost of matching two characters */
  protected double m_matchCost = -5;
  
  /** The cost of a substituting two characters */
  protected double m_subCost = 5;
  
  /** The cost of opening a gap */
  protected double m_gapStartCost = 5;
   ...
   * @return another AffineEditDistance with the same exact parameters as this  metric
   */
  public Object clone() {
    AffineEditDistance metric = new AffineEditDistance();
