...
/*
 *    DataDependentStringMetric.java
...
public interface DataDependentStringMetric {
   ...
   * @param stringList a list of strings that the metric is built on
   */
  public abstract void buildMetric(List<String> stringList) throws Exception;
