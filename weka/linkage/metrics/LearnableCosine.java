...
public class LearnableCosine extends StringMetric implements DataDependentStringMetric, LearnableStringMetric,
   ...
   */
  public void buildMetric(List<String> strings) throws Exception {
    m_stringRefHash = new HashMap();
    m_tokenHash = new HashMap();
    m_stringRefs = new ArrayList();
    m_trained = false;
  ...
  public void trainMetric(ArrayList pairList) throws Exception {
	...
	eval.crossValidateModel(classifier, instances, 2, new Random(0));
    ...
    System.out.println((new SimpleDateFormat("HH:mm:ss:")).format(new Date()) +
		       SumInstanceMetric.concatStringArray(((OptionHandler)m_classifier).getOptions()));
   ...
   * @return another LearnableCosine with the same exact parameters as this  metric
   */
  public Object clone() {
    LearnableCosine metric = new LearnableCosine();
  ...
  public String [] getOptions() {
    ...
    options[current++] = "-T";
    options[current++] = Utils.removeSubstring(m_tokenizer.getClass().getName(), "weka.linkage.metrics.");
