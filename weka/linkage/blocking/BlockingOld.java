 ...
 */
public class BlockingOld extends Blocking
  ...
  public InstancePair[] getMostSimilarPairs(int numPairs) {
    ...
    System.out.println("Blocking produced " + numPairs + " total pairs; " +
                       " out of which " + numGoodPairs + " are good. ("
                       + (100.0*numGoodPairs)/numPairs + "%");
    return pairs; 
  } 
